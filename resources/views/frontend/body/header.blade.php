        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown dropdown-small">
              ...
              <ul class="dropdown-menu">
                @if(session()->get('language') == 'bengali')
                <li><a href="{{ route('english.language') }}">Change to English</a></li>
                @else
                <li><a href="{{ route('bengali.language') }}">বাংলায় পরিবর্তন করুন</a></li>
                @endif
              </ul>
            </li>
          </ul>
                ...
                <ul class="categories-filter animate-dropdown">
                  ...
                  <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="category.html">Categories <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                      ...
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">{{ $category->category_name }}</a></li>
                      @endforeach
                    </ul>
                  </li>
